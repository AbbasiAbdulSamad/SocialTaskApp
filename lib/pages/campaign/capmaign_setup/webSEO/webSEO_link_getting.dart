...
class WebSEO_LinkGetting extends StatefulWidget {
  // getting page Data from select_list_data.dart
  String? goPage;
  WebSEO_LinkGetting({super.key, required this.goPage});

  @override
  State<WebSEO_LinkGetting> createState() => _WebSEO_LinkGettingState();
}
class _WebSEO_LinkGettingState extends State<WebSEO_LinkGetting> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope( // Back button to show pop alert confirm
        ...
        child: Scaffold(backgroundColor: theme.primaryFixed,
          ...
          appBar: AppBar(title: Text('Website $_onPage'),
              ...
              Column(mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [
                  ...
                  BgBox(
                    ...
                    child: Form(key: _formKey,
                      child: Column(mainAxisSize: MainAxisSize.min,
                        ...
                        children: [Ui.input(context, _linkController, 'Website URL', 'https://example.com/...',
                  ...
                  BgBox(
                    ...
                    child: Ui.bottomBar(context, 'How to get link: Go to your site -> copy the link of the page or article that has the most visitors',
                      'ico/google_login_icon.webp', 'Open Google', 'https://www.google.com',),
                  ),
                ],),

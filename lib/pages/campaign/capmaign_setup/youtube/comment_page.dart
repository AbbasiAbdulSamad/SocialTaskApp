...
class CommentPage extends StatelessWidget {
  ...
  void updateTotal(BuildContext context) {
    ...
    final subscriber = subscriberValue * 6;
    int watchtime = 0;
    if(selectedValue==20){watchtime = 2 * subscriberValue;
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  ytLayout(
                    ...
                    ytService: 'Comments',
                    ytServiceIcon: Icons.comment_sharp,),
                ],
              ),
            );
          },

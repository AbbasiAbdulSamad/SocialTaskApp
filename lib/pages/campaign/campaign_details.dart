...
import 'package:app/server_model/provider/campaign_api.dart';
...
class _CampaignDetailsState extends State<CampaignDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    final campaignsAction = Provider.of<CampaignsAction>(context);
                  ...
                  showDialog(context: context,
                    builder: (dialagCOntext) {
                      ...
                      return pop.backAlert(context: context,icon: Icons.campaign, title: 'Recreate Campaign',
                          ...
                          confirm: 'Yes Create', onConfirm: (){
                        campaignsAction.reCreateCampaign(
                              context: context,
                  ...
                  showDialog(context: context,
                    builder: (dialogContext) {
                      ...
                      return pop.backAlert(context: context,icon: Icons.delete, title: 'Confirm Delete',
                         ...
                         campaignsAction.deleteCompletedCampaign(context, widget.campaignId);
                         Navigator.of(context, rootNavigator: true).pop();
                      } );
                    },
                  );
                ...
                children: [
                  Column(
                    children: [
                        ...
                        child: Column(spacing: 13,
                          children: [
                            ...
                            Column(
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(widget.videoTitle, maxLines: 2,
                              ...
                              child:
                              (widget.social == "Instagram" && widget
                              ...
                              Column(children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(widget.videoTitle, maxLines: 4,
                                    overflow: TextOverflow.ellipsis,
                                    style: textTheme.displaySmall?.copyWith(
                                      fontSize: 20,
                                      color: theme.onPrimaryContainer,),
                                ...
                                SizedBox(height: 50,)
                                  ...
                                  : Stack(
                                children: [
                                  Ui.networkImage(context, widget.campaignImg,
                                      'assets/ico/image_loading.png',
                                      double.infinity,
                                      widget.social == "Website" ? 200 : 400),
                                  Positioned(
                                  ...
                                  widget.videoUrl.contains(
                                      "https://www.instagram.com/reel/") ||
                                      widget.videoUrl.contains("tiktok.com/") ?
                                  Positioned(
                                      left: 0, right: 0, top: 150,
                                      child: Image.asset(
                                        "assets/ico/tiktok_play_icon.webp",
                                        width: 60, height: 60,))
                                      : SizedBox()
                                ],
                              ),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                              children: [
                                Row(spacing: 5,
                                  children: [
                                    Image.asset(
                                      'assets/ico/${(widget.social == "YouTube")
                                          ? "youtube_icon.webp"
                                          : (widget.social == "TikTok")
                                          ? "tiktok_icon.webp"
                                          : (widget.social == "Website")
                                          ? "web.webp"
                                          : "insta_icon.webp"}', width: 20,),
                                    Text("${widget.social}", maxLines: 1,
                                      overflow: TextOverflow.ellipsis,
                                      style: textTheme.displaySmall?.copyWith(
                                          fontSize: 14),),
                                  ],
                                ...
                                Row(spacing: 5,
                                  children: [
                                    Text(widget.selectedOption, maxLines: 1,
                                      overflow: TextOverflow.ellipsis,
                                      style: textTheme.displaySmall?.copyWith(
                                          fontSize: 14),),
                                    Text('${widget.quantity} / ${widget.viewers }',
                                      style: textTheme.displaySmall?.copyWith(
                                          fontSize: 14,
                                ...
                                (widget.social == "YouTube" || widget.social ==
                                    "Website") ?
                                Row(spacing: 5,
                                  children: [
                                    Icon(Icons.arrow_forward_ios, size: 12,),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Expanded(child:
                                Ui.progressBar(widget.progress, "", 4, 8,
                                    lineColor: (widget.status == "Paused") ? Colors
                                ...
                                children: [
                                  Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                                    children: [
                                      ...
                                      Text("${widget.campaignCost}",
                                        style: textTheme.labelMedium?.copyWith(color: theme.errorContainer),),
                                    ],),
                                  Ui.lightLine(),
                            ...
                            (widget.status == "Completed" || widget.status == "Processing")
                                ?const SizedBox() :
                            Opacity(
                              opacity: 0.7,
                              child: Container(
                                ...
                                padding: const EdgeInsets.symmetric(vertical: 10),
                                decoration: BoxDecoration(
                                    color: (widget.status == "Unavailable" ||
                                        widget.status == "Blocked") ? Colors
                                        .redAccent.shade100 : Colors.orange
                                        .shade200,
                                    borderRadius: BorderRadius.circular(8)
                                ),
                                width: double.infinity,
                                // BLocked
                                child: Text((widget.status == "Blocked")
                                    ? 'This campaign has been blocked due to policy'
                                    :
                                // Unavailable
                                (widget.status == "Unavailable")
                                    ?
                                "The link is no longer available on ${widget
                                    .social}. "
                            ...
                            if(widget.status == "Unavailable" ||
                              ...
                              GestureDetector(
                                  onTap: () {
                                    launchUrl(Uri.parse(
                                        'https://socialtask.xyz/privacy-policy/'));
                                  },
                                  child: const Text(
                      ...
                      Text('List of those who completed the task',
                        style: textTheme.displaySmall?.copyWith(
                            fontSize: 16, color: theme.onPrimaryContainer),),
                      Container(
                        margin: const EdgeInsets.symmetric(
                      ...
                      isLoadingViewers ? Padding(
                        ...
                        child: Center(child: Ui.loading(context)),
                      )
                          : viewers.isEmpty
                              ...
                              leading: Container(
                                ...
                                child: ClipOval(
                                  child: viewer['profile'] != null
                                      ? Ui.networkImage(context, viewer['profile'],
                                      'assets/ico/user_profile.webp', 90, 90)
                                      : Image.asset('assets/ico/user_profile.webp'),
                                ),
                              ),
                              title: Text(viewer['name'] ?? 'Unknown', maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: textTheme.displaySmall?.copyWith(
                                    fontSize: 17),),
                              trailing: SizedBox(width: 20, height: 20,
                                child: Ui.countryFlag(
                                    viewer['country'] ?? 'Unknown'),),),
                          );
                        },
                      ),
                  ...
                  if (campaignsAction.isLoading)
                    Positioned.fill(
                      child: Container(
                        color: Colors.black.withOpacity(0.2),
                        child: Center(
                          child: Ui.screenLoading(context, loadinText: "Processing..."),
                        ),
                      ),
                    ),
                ],

...
import 'package:app/ui/shortPageOpen.dart';
    ...
    loadTickets().then((_){
      if (mounted && tickets.isEmpty) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          Shortpageopen.shortPage(context, Icons.support_agent, 'Create Support Request', _supportWidget());
        });
      }
    });
  }
  ...
  Widget _addSupportButton(){
    ...
    return Container(
      ...
      child: MyButton(
        ...
        onClick: ()=> Shortpageopen.shortPage(context, Icons.support_agent, 'Create Support Request', _supportWidget()),
      ),
    );
  }
